  ...
  return (
    <header className="relative overflow-hidden bg-char-soft border-b border-char-line">
      ...
      <div className="relative mx-auto max-w-3xl px-5 pt-8 pb-6 text-center sm:pt-12 sm:pb-8">
        ...
        <h1 className="font-display text-4xl font-extrabold text-cream sm:text-5xl">مطعم الجواد</h1>
        <p className="mx-auto mt-3 max-w-sm font-body text-sm leading-relaxed text-cream-muted sm:text-base">نكهات أصيلة من المطبخ العربي، تُحضّر بشغف وتُقدّم بحب — قائمتنا لهذا اليوم</p>
