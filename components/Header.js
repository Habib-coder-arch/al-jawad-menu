...
export default function Header() {
  return (
    <header className="relative overflow-hidden bg-char-soft">
      ...
      {/* top double-rule, menu-cover style */}
      ...
      <div className="relative mx-auto max-w-3xl px-5 pt-7 pb-6 text-center sm:pt-10 sm:pb-8">
        ...
        <h1 className="font-display text-4xl font-extrabold tracking-tight text-cream drop-shadow-sm sm:text-5xl">
          مطعم الجواد
        </h1>

        <p className="mx-auto mt-3 max-w-sm font-body text-sm italic leading-relaxed text-cream-muted sm:text-base">
